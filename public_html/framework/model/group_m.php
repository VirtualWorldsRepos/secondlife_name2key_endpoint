...
	class group_m_set extends collectionSet
	{
		public function get_object_by_field(string $fieldname,$value) : ?group_m
		{
			return parent::get_object_by_field($fieldname,$value);
		}
		public function get_object_by_id($id=null) : ?group_m
		{
			return parent::get_object_by_id($id);
		}
		public function get_first() : ?group_m
		{
			return parent::get_first();
		}
	}
	
	class group_m extends genClass
	{
		protected $use_table = "group_m";
