...
	class group_0_set extends collectionSet
	{
		public function get_object_by_field(string $fieldname,$value) : ?group_0
		{
			return parent::get_object_by_field($fieldname,$value);
		}
		public function get_object_by_id($id=null) : ?group_0
		{
			return parent::get_object_by_id($id);
		}
		public function get_first() : ?group_0
		{
			return parent::get_first();
		}
	}
	
	class group_0 extends genClass
	{
		protected $use_table = "group_0";
