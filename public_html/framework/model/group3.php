...
	class group3_set extends collectionSet
	{
		public function get_object_by_field(string $fieldname,$value) : ?group3
		{
			return parent::get_object_by_field($fieldname,$value);
		}
		public function get_object_by_id($id=null) : ?group3
		{
			return parent::get_object_by_id($id);
		}
		public function get_first() : ?group3
		{
			return parent::get_first();
		}
	}
	
	class group3 extends genClass
	{
		protected $use_table = "group3";
