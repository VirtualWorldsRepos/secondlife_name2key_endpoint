...
	class group_x_set extends collectionSet
	{
		public function get_object_by_field(string $fieldname,$value) : ?group_x
		{
			return parent::get_object_by_field($fieldname,$value);
		}
		public function get_object_by_id($id=null) : ?group_x
		{
			return parent::get_object_by_id($id);
		}
		public function get_first() : ?group_x
		{
			return parent::get_first();
		}
	}
	
	class group_x extends genClass
	{
		protected $use_table = "group_x";
