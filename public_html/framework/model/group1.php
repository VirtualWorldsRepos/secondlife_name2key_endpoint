...
	class group1_set extends collectionSet
	{
		public function get_object_by_field(string $fieldname,$value) : ?group1
		{
			return parent::get_object_by_field($fieldname,$value);
		}
		public function get_object_by_id($id=null) : ?group1
		{
			return parent::get_object_by_id($id);
		}
		public function get_first() : ?group1
		{
			return parent::get_first();
		}
	}
	
	class group1 extends genClass
	{
		protected $use_table = "group1";
