...
	class group_a_set extends collectionSet
	{
		public function get_object_by_field(string $fieldname,$value) : ?group_a
		{
			return parent::get_object_by_field($fieldname,$value);
		}
		public function get_object_by_id($id=null) : ?group_a
		{
			return parent::get_object_by_id($id);
		}
		public function get_first() : ?group_a
		{
			return parent::get_first();
		}
	}
	
	class group_a extends genClass
	{
		protected $use_table = "group_a";
